...
class ItemCart extends Component
{
    ...
    */
    ...
    public function mount(CartItem $item): void
    {
        ...
        $this->subtotal_item = $this->item->quantity * $this->item->unit_price;
    }
    ...
    {
        // Return the Blade view located at resources/views/livewire/global/ui/item-cart.blade.php.
        return view('livewire.global.ui.item-cart');
    }
}
