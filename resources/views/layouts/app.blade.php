...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Shop the latest fashion trends with SQ1-Store. Discover stylish clothing, accessories, and more on our online store.">
