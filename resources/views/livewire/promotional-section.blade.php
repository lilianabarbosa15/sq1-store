...
>
    <p class="font-semibold text-[clamp(16px,6vw,24px)]">
        {{__('Extra 30% Off Online')}}
    </p>
    <p class="font-bold text-[clamp(24px,9vw,48px)]">
        {{__('Summer Season Sale')}}    
    </p>
    <p class="font-normal text-[clamp(14px,4vw,16px)]">
        {{__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel dolor
